...
$ns connect $tahoe22 $sink6
	$tahoe22 set packetSize_ 5000.0
	$tahoe22 set fid_ 1
...
$ns connect $newReno24 $sink8
	$newReno24 set packetSize_ 5000.0
...
$ns connect $vegas27 $sink11
	$vegas27 set packetSize_ 5000.0
	$vegas27 set fid_ 4
